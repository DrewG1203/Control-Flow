    ...
    public static void main(String[] Args) {
        ...
        if (toContinue.equalsIgnoreCase("yes") || toContinue.equalsIgnoreCase("y") ) {
            do {
                 ...
                 *As well as setting to 0 if the user says doesn't have favorite
                 *QB number.
                 */
                int favQBNum = 1;
                ...
                if (favQBNum == 0) {
                    //automatically set QB to the goat's (Tom Brady) jersey number//
                    favQBNum = 12;
            ...
            finalContinue = userInput.nextLine();
